...
uint256 hashGenesisBlock("0xc743cd09333fddd03b533f5709c4634a2c3cc057380eb693f18a59ab7789f494");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 420000); // Litecoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3 * 24 * 60 * 60; // Litecoin: 3.5 days
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x397e130ee4cceca90816d0066136b546e45236d9c435fb31490a189042c28e38");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "1/14/2020 - Technovison hits over a million view";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 25 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("043e28c17a8697bd54f58f623b91850765bbe3b382e909f6452fabea6ac43403c417063ec2b216c47551bace2daba83ee26e4287153783df96958bd84806a5fc7b") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1670952172;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084839819;

        if (fTestNet)
        {
            block.nTime    = 1670952143;
            block.nNonce   = 386632862;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xdd0eeb8490e6aea0f13ebde91d3ec56a59cf7d379608340973172ab64954b24f"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc1, 0xb2, 0xdc }; // Litecoin: increase each by adding 2 to bitcoin's value.
